// File: components/ReviewModal.jsx
    ...
    <div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center z-50 ">
          ...
          <div className="text-lg font-semibold text-gray-800 mb-4" style={{ fontFamily: "IvyMode" }}>
              Add a review
            </div>
            <div className="mt-[-20px] ml-[30px]">
                <IoIosCloseCircleOutline onClick={() => setIsModalOpen(false)} className="text-2xl text-gray-500 cursor-pointer bg-white "/>
            </div>
          </div>
            <p className="text-sm text-gray-600 mb-6" style={{ fontFamily: "BrownRegular" }}>
            ...
            <div className="mb-4">
              <p className="text-sm font-medium text-gray-700 mb-1" style={{ fontFamily: "BrownRegular" }}>
                Quality of Event
              </p>
