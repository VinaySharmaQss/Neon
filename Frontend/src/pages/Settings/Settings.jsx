    ...
    <>
     <Navbar/>
      ...
      <div className={styles.settingRow}>
        <div>
          <p className={styles.settingTitle}>Personal and Account Information</p>
          <p className={styles.settingDescription}>
            Would you like to share your personal information with us to know
            you better?
          </p>
        </div>
        <div>
      ...
      <div className={styles.settingRow}>
        <div>
          <p className={styles.settingTitle}>Consent for sharing information with operators</p>
          <p className={styles.settingDescription}>
            Would you like to share your personal information with the operator
            to serve you better?
          </p>
        </div>
        <div>
      ...
      <div className={styles.settingRow}>
        <div>
          ...
          <p className={styles.settingDescription}>
            Would you like to receive notifications about upcoming events and updates?
          </p>
        </div>
        <div>
          <label className={styles.switch}>
      ...
      <div className={styles.settingRow}>
        <div>
          ...
          <p className={styles.settingDescription}>
            Would you like to enable location services to get better recommendations?
          </p>
        </div>
        <div>
          <label className={styles.switch}>
      ...
      <p className="text-gray-600 mb-2">Which type of notifications would you like to receive?</p>
